    ...
    <div className="bg-secondary absolute top-2/4 left-2/4 translate-x-2/4 translate-y-2/4 w-full lg:w-9/12">
      <div className="lg:flex justify-between items-center">
        ...
        <div  className="mt-12 lg:mt-0 text-center">
          <h1 className="text-2xl font-bold mb-3">Existing User</h1>
          ...
          >
            ...
            <button
              type="submit"
              className={`text-center py-3 w-1/2 m-auto mt-12 block cursor-pointer px-4 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 lg:-right-32
